...
export class MenuConfigurationComponent implements OnInit, CanComponentDeactivate, AfterViewInit, OnDestroy {
    ...
    public enableMenuContent: boolean;
    public selectMenu: any;
    public selectedMeunIndex: any;
    public arr_icon: any[];
    ...
    constructor(private sanitizer: DomSanitizer,
        ...
        //gjc 0526
        this.enableMenuContent = false;
        this.selectedMeunIndex = 0;
        //jcr 416
    ...
    onSubmit(form: NgForm) {
        $('.loadingbar').css('display',''); 
        this.enableMenuContent = false;
        form.value.menu_type = this.selectMenu.menuTypeId;
        $('#menu_name').modal('toggle');
...
// 2018-2-11
                            ...
                            .subscribe(
                                res => {
                                    ...
                                    if (mform.value.selct_menu_type == 12 || mform.value.selct_menu_type == 11) {
                                        ...
                                        Observable.forkJoin(...observable_array)
                                            .finally(() => {
                                        ...
                                        Observable.forkJoin(...delete_observable_array).subscribe(
                                            data => {
                                                ...
                                                Observable.forkJoin(...save_observable_array)
                                                    .finally(() => {
    ...
    select_menu(index){
        this.selectedMeunIndex = index;
        this.enableMenuContent = true;
        this.selectMenu = this.menuTypeData[index];//selected menu name
    }

    make_menu_name(){
        //here make menu first name
    }
}